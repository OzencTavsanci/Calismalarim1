...
public class Sahis extends Kisi {
	...
	public Sahis(String ad, String dogumTarihi, String kimlikNo, String yasadigiYer, int telefonNo, String email,String tahsili, String meslegi, String sicilKaydi) {
	...
	public String toString() {
		return "[0]" + getAd() + "|" + getDogumTarihi()	+ "|" + getKimlikNo() + "|" + getYasadigiYer() + "|" + getTelefonNo() + "|" + getEmail()+ "|" + getTahsili()
